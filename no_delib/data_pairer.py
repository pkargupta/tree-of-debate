...
def parse_papers(focus_paper, cited_paper):
    ...
    data = []
    data.append({'focus':{'title':unidecode(focus_data['title']), 'abstract':unidecode(focus_data['abstract']), 
                          'introduction':unidecode(focus_data['introduction']), 'full_text':focus},
                 'cited':{'title':unidecode(cited_data['title']), 'abstract':unidecode(cited_data['abstract']),
                          'introduction':unidecode(cited_data['introduction']),'full_text':cited}})
