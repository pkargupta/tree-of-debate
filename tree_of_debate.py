...
def run_code(args, topic, f_pap, c_pap):
    ...
    subtrees = root_node.conduct_self_deliberation(leaf_node_label, paper_authors, moderator, log=extra_log_folder) # k new, finer topics to discuss
    ...
    while len(queue_of_rounds) > 0:
        ...
        if is_expand and depth < max_depth:
            new_subtrees = round.conduct_self_deliberation(round.round_topic, paper_authors, moderator, log=extra_log_folder)
