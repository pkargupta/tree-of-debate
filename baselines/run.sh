...
python run_model.py --dataset_path data.csv --base_llm nvidia/Llama-3.1-Nemotron-70B-Instruct-HF --baseline_type split
python run_model.py --dataset_path data.csv --base_llm nvidia/Llama-3.1-Nemotron-70B-Instruct-HF --baseline_type prompt_intro
