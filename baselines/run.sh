...
python run_model.py --dataset_path data.csv --base_llm meta-llama/Meta-Llama-3.1-8B-Instruct --baseline_type split
python run_model.py --dataset_path data.csv --base_llm meta-llama/Meta-Llama-3.1-8B-Instruct --baseline_type prompt_intro
